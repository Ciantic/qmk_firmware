...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 [3] = KEYMAP(KC_NO,KC_F1,KC_F2,KC_F3,KC_F4,KC_F5,KC_F6,KC_NO,KC_NO,KC_NONUS_HASH,LSFT(KC_3),LSFT(KC_6),KC_NO,KC_NO,KC_NO,LSFT(KC_1),LSFT(KC_2),RALT(KC_2),RALT(KC_4),LSFT(KC_5),KC_NO,KC_NONUS_BSLASH,LSFT(KC_NONUS_BSLASH),RALT(KC_NONUS_BSLASH),KC_NO,KC_NO,KC_NO,KC_TRNS,KC_NO,KC_TRNS,KC_TRNS,KC_TRNS,KC_NO,KC_NO,KC_NO,KC_LSHIFT,KC_NO,KC_NO,KC_F7,KC_F8,KC_F9,KC_F10,KC_F11,KC_F12,LSFT(KC_EQUAL),KC_NO,LSFT(KC_EQUAL),LSFT(KC_7),RALT(KC_8),RALT(KC_9),KC_NO,KC_RBRACKET,LSFT(KC_0),RALT(KC_7),LSFT(KC_8),LSFT(KC_9),RALT(KC_0),KC_NONUS_HASH,KC_ENTER,KC_TRNS,RALT(KC_MINUS),LSFT(KC_MINUS),KC_MINUS,LSFT(KC_NONUS_HASH),KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_LSHIFT),
