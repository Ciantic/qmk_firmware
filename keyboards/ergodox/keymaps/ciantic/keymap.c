...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = KEYMAP(KC_ESCAPE, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_TAB, KC_Q, KC_W, KC_E, KC_R, KC_T, KC_NO, MO(1), KC_A, KC_S, KC_D, KC_F, KC_G, KC_LSHIFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_LGUI, KC_LCTL, KC_NONUS_BSLASH, KC_LGUI, KC_LALT, MO(3), KC_NO, KC_NO, KC_NO, KC_SPACE, MO(4), KC_NO, KC_EQUAL, KC_7, KC_8, KC_9, KC_0, KC_MINUS, KC_BSPACE, KC_NO, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_NONUS_HASH, KC_H, KC_J, KC_K, KC_L, KC_SCOLON, KC_QUOTE, KC_NO, KC_N, KC_M, KC_COMMA, KC_DOT, KC_SLASH, KC_RSHIFT, MO(3), KC_RALT, KC_APPLICATION, KC_NO, KC_LCTL, KC_NO, KC_NO, KC_NO, KC_NO, MO(4), KC_SPACE),
 ...
 [3] = KEYMAP(KC_NO,KC_F1,KC_F2,KC_F3,KC_F4,KC_F5,KC_F6,KC_NO,KC_NO,KC_NO,LSFT(KC_3),LSFT(KC_6),KC_NO,KC_NO,KC_NO,LSFT(KC_1),LSFT(KC_2),RALT(KC_2),RALT(KC_4),LSFT(KC_5),KC_NO,KC_NONUS_BSLASH,LSFT(KC_NONUS_BSLASH),RALT(KC_NONUS_BSLASH),KC_NO,KC_NO,KC_NO,KC_TRNS,KC_NO,KC_TRNS,KC_TRNS,KC_TRNS,KC_NO,KC_NO,KC_NO,KC_LSHIFT,KC_NO,KC_NO,KC_F7,KC_F8,KC_F9,KC_F10,KC_F11,KC_F12,LSFT(KC_EQUAL),KC_NO,LSFT(KC_EQUAL),LSFT(KC_7),RALT(KC_8),RALT(KC_9),KC_NO,KC_RBRACKET,LSFT(KC_0),RALT(KC_7),LSFT(KC_8),LSFT(KC_9),RALT(KC_0),KC_NONUS_HASH,KC_ENTER,KC_TRNS,RALT(KC_MINUS),LSFT(KC_MINUS),KC_MINUS,LSFT(KC_NONUS_HASH),KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_LSHIFT),
