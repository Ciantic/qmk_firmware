...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = KEYMAP(KC_ESCAPE, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_TAB, KC_Q, KC_W, KC_E, KC_R, KC_T, KC_NO, MO(1), KC_A, KC_S, KC_D, KC_F, KC_G, OSM(MOD_LSFT), KC_Z, KC_X, KC_C, KC_V, KC_B, OSM(MOD_LGUI), OSM(MOD_LCTL), KC_NONUS_BSLASH, OSM(MOD_LGUI), OSM(MOD_LALT), MO(3), KC_MEDIA_PLAY_PAUSE, KC_AUDIO_MUTE, KC_NO, KC_SPACE, OSL(4), KC_ESCAPE, KC_6, KC_7, KC_8, KC_9, KC_0, KC_NO, KC_BSPACE, KC_NO, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_NONUS_HASH, KC_H, KC_J, KC_K, KC_L, KC_SCOLON, KC_QUOTE, KC_NO, KC_N, KC_M, KC_COMMA, KC_DOT, KC_SLASH, OSM(MOD_RSFT), MO(3), OSM(MOD_RALT), KC_APPLICATION, KC_NO, OSM(MOD_LCTL), KC_MEDIA_REWIND, KC_MEDIA_FAST_FORWARD, KC_NO, KC_NO, OSL(4), KC_SPACE),
  [1] = KEYMAP(KC_NO, LALT(LCTL(LGUI(LSFT(KC_1)))), LALT(LCTL(LGUI(LSFT(KC_2)))), LALT(LCTL(LGUI(LSFT(KC_3)))), LALT(LCTL(LGUI(LSFT(KC_4)))), LALT(LCTL(LGUI(LSFT(KC_5)))), KC_NO, KC_TRNS, LALT(LCTL(LGUI(LSFT(KC_Q)))), LALT(LCTL(LGUI(LSFT(KC_W)))), LALT(LCTL(LGUI(LSFT(KC_E)))), LALT(LCTL(LGUI(LSFT(KC_R)))), LALT(LCTL(LGUI(LSFT(KC_T)))), KC_NO, KC_TRNS, KC_NO, LALT(LCTL(LSFT(KC_S))), KC_LALT, KC_LSHIFT, KC_NO, KC_TRNS, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, RGB_HUI, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, RGB_MOD, RGB_SLD, RGB_VAI, KC_LCTL, RGB_TOG, RGB_VAD, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_DELETE, KC_HOME, KC_UP, KC_END, KC_PGUP, KC_NO, KC_ENTER, KC_LEFT, KC_DOWN, KC_RIGHT, KC_PGDOWN, KC_NO, KC_NO, KC_BSPACE, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_NO, KC_SYSTEM_SLEEP, KC_NO, KC_NO, KC_NO, KC_TRNS),
